...
const BROKEN_PATCH = "scripts/patch_step_16_lock_authorization_contract_v1.mjs";

// ------------------------------------------------------------
// 0) Stub the broken v1 patch so nobody runs it again by accident
// ------------------------------------------------------------
...
`;
  ...
  console.log("OK: stubbed broken patch_step_16_lock_authorization_contract_v1.mjs");
}
...
//
// IMPORTANT: Avoid any Bash ${...} sequences inside this JS template literal.
// ------------------------------------------------------------
...
//    Prefer after smoke_cross_domain_scope_spoofing
// ------------------------------------------------------------
